...
public class SkuBoundsController {
    ...
    @ApiOperation("保存所有sku营销信息")
    @PostMapping("/saleInfo/save")
    public Resp<Object> saveSkuSaleInfos(@RequestBody List<SkuSaleInfoTo> skus) {
        log.info("sms 接收到 数据...{}", skus);
        skuBoundsService.saveSkuAllSaleInfo(skus);
        return Resp.ok(null);
    }
